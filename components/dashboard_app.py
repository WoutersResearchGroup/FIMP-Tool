...
def main():
    ...
    # Load and filter data for each KPI
    df_P1_KPI = pd.read_csv("Pillar 1 KPI.csv")
    ...
    df_P2_KPI = pd.read_csv("Pillar2_KPI.csv")
    ...
    df_P3_KPI = pd.read_csv("Pillar3_KPI.csv")
    ...
    df_P4_KPI = pd.read_csv("Pillar4_KPI.csv")
    ...
    # Initialize the dashboard layout if not already created
